"""
server.py — §3.3 (Python UDP server)
...
Lightweight UDP server that mediates between Unity (over UDP) and any external processes (logging, eye-tracker bridge, optional ROS bridge). Used in the simulator-only configuration of the user study.
